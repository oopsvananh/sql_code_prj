...
CREATE TABLE `room_service` (
  ...
  CONSTRAINT `room_service_ibfk_1` FOREIGN KEY (`room_rental_id`) REFERENCES `room_rental` (`id`),
  CONSTRAINT `room_service_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`)
